...
class HomeMenuViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,UITabBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        var logOutBtn = UIBarButtonItem(title: "Log Out", style: UIBarButtonItemStyle.Bordered, target: self, action:"logout")
    ...
    func logout()
    {
        ...
        var loginOBJ = self.storyboard.instantiateViewControllerWithIdentifier("login") as LoginViewController
        loginOBJ.navigationItem.hidesBackButton=true
        self.navigationController.pushViewController(loginOBJ, animated: false)
       // self.navigationController.popToViewController(loginOBJ, animated: false)
