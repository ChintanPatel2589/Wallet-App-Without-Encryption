...
class DataDisplayViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,UITabBarDelegate,UIAlertViewDelegate {
    ...
    func tableView(tableView: UITableView!, cellForRowAtIndexPath indexPath: NSIndexPath!) -> UITableViewCell!
    {
        ...
        if !cell {
            ...
            lblDesc=UILabel(frame: CGRectMake(10, 23, 280, 21))
        ...
        {
             //println("\(arrayDataList.objectAtIndex(indexPath.row))")
            ...
            if lblDesc.text.lengthOfBytesUsingEncoding(NSUTF8StringEncoding) == 0
            {
                var rlblTitleFrame = lblTitle.frame
                rlblTitleFrame.origin.y = cell!.frame.size.height/2 - lblTitle.frame.height/2
                lblTitle.frame = rlblTitleFrame
            }
            else
            {
                var rlblTitleFrame = lblTitle.frame
                rlblTitleFrame.origin.y = 5
                lblTitle.frame = rlblTitleFrame
            }
   ...
   func tableView(tableView: UITableView!, editingStyleForRowAtIndexPath indexPath: NSIndexPath!) -> UITableViewCellEditingStyle
    {
        ...
        if self.arrayDataList.count > 0
        {
             style = UITableViewCellEditingStyle.Delete
        }
        else
        {
